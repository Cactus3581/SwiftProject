//
//  UserProfileCourseTableViewCell.swift
//  SwiftProject
//
...
class UserProfileCourseTableViewCell: UITableViewCell, UserProfileTableViewCellProtocol {
    ...
    var cellViewModel: Any? {
        didSet {
            guard let cellViewModel = cellViewModel as? UserProfileCourseCellViewModelProtocol else {
                return
            }
